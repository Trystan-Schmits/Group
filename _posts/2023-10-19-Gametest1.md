...
function frame(){ //when a frame is updated
    var characterRect = myCharacterObject.getBoundingBox(); // Get character's bounding box
    var doorRect = doorObject.getBoundingBox(); // Get door's bounding box

    // Check if the character and door bounding boxes overlap
    if (
        ...
        // Characters overlap, show the message

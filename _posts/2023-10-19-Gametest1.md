...
//create objects
    ...
    myCharacterObject.UpdateCameraScroll = [0,0];
    //backgrounds
...
var display = new subDisplay(canvas,[backgroundObject,myCharacterObject]);
...
function frame(){ //when a frame is updated
    ...
    backgroundObject.UpdateCameraScroll([pos[0],0]);
    ...
    if(currentFrame % Math.round(fps/4)==0){ //update lighting
        light([[50,15,2.5],[450,15,2.5],[850,15,2.5]],lightObject,hiddenCanvas,true)
    } 
